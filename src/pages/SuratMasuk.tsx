...
const SuratMasukPage: React.FC = () => {
  ...
  const handleEdit = () => {
    ...
    updateSuratMasuk(selectedItem.id, {
      kodeSurat: formData.kodeSurat,
      nomorSuratMasuk: formData.nomorSuratMasuk,
      namaPengirim: formData.namaPengirim,
      perihal: formData.perihal,
    ...
    toast({
      title: 'Berhasil',
      description: 'Data surat masuk berhasil diperbarui.',
    });
    setIsEditOpen(false);
    loadData();
  };
  ...
  const handleDelete = () => {
    ...
    deleteSuratMasuk(selectedItem.id);
    toast({
      title: 'Berhasil',
      description: 'Data surat masuk berhasil dihapus.',
    });
  ...
  const handleUpdateStatus = (item: SuratMasuk) => {
    const newStatus = item.status === 'Belum Disposisi' ? 'Sudah Disposisi' : 'Belum Disposisi';
    updateSuratMasuk(item.id, { status: newStatus });
    toast({
  ...
  const handleExport = () => {
    ...
    toast({
      ...
      description: 'Data surat masuk berhasil diekspor.',
    });
  };
  ...
  return (
    <MainLayout>
      <PageHeader 
        title="Surat Masuk" 
        description="Kelola data surat masuk KC Telihan"
      />
      ...
      <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Masukkan data surat masuk baru
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle className="font-display">Detail Surat Masuk</DialogTitle>
          </DialogHeader>
          {selectedItem && (
            <div className="space-y-4 py-4">
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle className="font-display">Edit Surat Masuk</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
      ...
      <AlertDialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Apakah Anda yakin ingin menghapus surat masuk dengan nomor agenda "{selectedItem?.nomorAgenda}"? 
