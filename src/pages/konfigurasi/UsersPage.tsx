...
const UsersPage: React.FC = () => {
  ...
  const handleAdd = () => {
    ...
    setIsAddOpen(false);
    setFormData({ nama: '', username: '', password: '', role: 'user', keterangan: '' });
    setData(getUsers());
  };
  ...
  return (
    <MainLayout>
      ...
      <DataTable data={data} columns={columns} onAdd={() => setIsAddOpen(true)} onDelete={(item) => { setSelectedItem(item); setIsDeleteOpen(true); }} searchPlaceholder="Cari user..." addLabel="Tambah User" />
