...
const SuratKeluarPage: React.FC = () => {
  ...
  const handleEdit = () => {
    ...
    updateSuratKeluar(selectedItem.id, formData);
    toast({
      title: 'Berhasil',
      description: 'Data surat keluar berhasil diperbarui.',
    });
    setIsEditOpen(false);
    loadData();
  };
  ...
  const handleDelete = () => {
    ...
    deleteSuratKeluar(selectedItem.id);
    toast({
      title: 'Berhasil',
      description: 'Data surat keluar berhasil dihapus.',
    });
  ...
  const handleUpdateStatus = (item: SuratKeluar) => {
    const newStatus = item.status === 'Belum Dikirim' ? 'Sudah Dikirim' : 'Belum Dikirim';
    updateSuratKeluar(item.id, { status: newStatus });
    toast({
  ...
  const handleExport = () => {
    ...
    toast({
      ...
      description: 'Data surat keluar berhasil diekspor.',
    });
  };
  ...
  return (
    <MainLayout>
      <PageHeader 
        title="Surat Keluar" 
        description="Kelola data surat keluar KC Telihan"
      />
      ...
      <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Masukkan data surat keluar baru
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <Label>Tujuan Surat (Instansi/Alamat)</Label>
              <Input 
      ...
      <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle className="font-display">Detail Surat Keluar</DialogTitle>
          </DialogHeader>
          {selectedItem && (
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{selectedItem.namaPenerima}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Tujuan Surat</p>
                  <p className="font-medium">{selectedItem.tujuanSurat || '-'}</p>
                </div>
                ...
                <div>
                  ...
                  <Badge variant={selectedItem.status === 'Sudah Dikirim' ? 'default' : 'secondary'}>
                    {selectedItem.status}
                  </Badge>
                </div>
                <div>
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle className="font-display">Edit Surat Keluar</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
      ...
      <AlertDialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Apakah Anda yakin ingin menghapus surat keluar dengan nomor agenda "{selectedItem?.nomorAgenda}"?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
