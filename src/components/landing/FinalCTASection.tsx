      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center gap-3 mb-12">
            <Button 
              size="lg" 
              className="px-12 py-7 text-lg font-bold bg-gradient-to-r from-brand-secondary to-amber-500 hover:from-brand-secondary/90 hover:to-amber-500/90 text-slate-900 shadow-2xl shadow-brand-secondary/30 hover:shadow-brand-secondary/50 transition-all duration-300 hover:scale-105"
              onClick={() => navigate('/login')}
            >
              Login Pegawai
              <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
            <span className="text-sm text-blue-200/70">Akses aman untuk pegawai Bankaltimtara</span>
          </div>
