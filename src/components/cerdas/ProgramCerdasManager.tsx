...
const ProgramCerdasManager: React.FC = () => {
  ...
  if (isLoading || !cfg) return <div className="p-6 text-muted-foreground">Memuat konfigurasi CERDAS…</div>;
...
export default ProgramCerdasManager;
